...
import {
	calculateCapacity,
	calculateTerrainCapacity,
	getRetainerSegments,
} from './terrain-evaluator'
...
describe('terrain-evaluator', () => {
	describe('no retention', () => {
      ...
      `)
			...
			const actualResult = getRetainerSegments(input)
	...
	describe('calculateCapacity', () => {
		it('calculates capacity for given terrain', () => {
			const input = stringLinesToLengths(`
        x
        xxx
        x..
      ...
      `)
			...
			const actualResult = calculateCapacity(input, start, end)
			expect(actualResult).toEqual(expectedResult)
		})
	})
	describe('task input', () =>
		it('calculates capacity for task input', () => {
			...
			const actualResult = calculateTerrainCapacity(input)
			expect(actualResult).toEqual(expectedResult)
		}))
})
